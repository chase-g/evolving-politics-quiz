...
var initialQ1 = ['id="libAnswer1" name="initialQ1" onclick=next()>&#9Individuals should be left to make choices by their own lights.','id="conAnswer1" name="initialQ1" onclick=next()>&#9Tradition often represents accumulated wisdom.','id="proAnswer1" name="initialQ1" onclick=next()>&#9From each according to his ability, to each according to his needs.'];
var initialQ2 = ['id="libAnswer2" name="initialQ2" onclick=next()>&#9A bill that scales back zoning laws and occupational licensing, cuts the income tax, and legalizes marijuana.','id="conAnswer2" name="initialQ2" onclick=next()>&#9A bill that provides a child tax credit, protects religious freedom of conscience to opt out of government mandates, and increases the budget for immigration enforcement.','id="proAnswer2" name="initialQ2" onclick=next()>&#9A bill that provides funding for health clinics which provide free birth control, provides additional funding for community colleges, and expands background check requirements for gun purchases.'];
...
var initialQ4 = ['id="libAnswer4" name="initialQ4" onclick=next()>&#9Intervention by politicians and bureaucrats often triggers unintended consequences which are more harmful than the initial problem.','id="conAnswer4" name="initialQ4" onclick=next()>&#9Government simply needs to punish wrongdoers and protect good people.','id="proAnswer4" name="initialQ4" onclick=next()>&#9It is irresponsible to ignore the suffering of others when the cost of helping is less than the amount of suffering that would be alleviated.'];
...
var startQ4 = ["What best reflects your view of how government should approach major social and economic problems, such as violent crime and job losses?"];
...
window.onload = function() {
  go(locations, questions, questionIds, answers);
}
